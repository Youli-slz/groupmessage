    ...
    <div class="main">
      <div class="admin-slider">
        <el-menu :default-active="active" class="el-menu-vertical-demo" @select='handselect'>
          ...
          <el-menu-item index="/madegroup"><i class="el-icon-message"></i>创建群管</el-menu-item>
          <el-menu-item index="/groupmessage"><i class="el-icon-message"></i>群发</el-menu-item>
          <el-menu-item index="/book"><i class="el-icon-message"></i>书单管理</el-menu-item> 
          <el-menu-item index="/addbanner"><i class="el-icon-message"></i>添加banner</el-menu-item> 
          <el-menu-item index="/story"><i class="el-icon-message"></i>故事管理</el-menu-item>                                                                   
        </el-menu>
      </div>
